    ...
    try
        ...
        case StateInfo of
            error ->
                ...
                ?alert_stacktrace("Security breach attempt spotted. Request params:~n~p", [ParamsProplist]),
            ...
            Props ->
                ...
                case Module:validate_login() of
                    {error, Reason} ->
                        ...
                        ?alert_stacktrace("Security breach attempt spotted. Reason:~p~nRequest params:~n~p", [Reason, ParamsProplist]),
                        {error, ?error_auth_invalid_request};
