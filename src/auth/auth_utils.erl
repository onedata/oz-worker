    ...
    try
        ...
        case StateInfo of
            error ->
                ...
                ?alert_stacktrace("Security breach attempt spotted - invalid state. GET params:~n~pPOST params:~n~p",
            ...
            Props ->
                ...
                case Module:validate_login() of
                    {error, Reason} ->
                        ...
                        ?alert_stacktrace("Security breach attempt spotted. Reason:~p~nRequest params:~n~pPOST params:~n~p",
                            [Reason, ParamsProplist, gui_ctx:form_params()]),
                        {error, ?error_auth_invalid_request};
                            ...
                            true ->
                                ...
                                case user_logic:get_user({connected_account_user_id, {ProviderID, UserID}}) of
                                    ...
                                    _ ->
                                        ...
                                        case is_any_email_in_use(Emails, gui_ctx:get_user_id()) of
                                            true ->
