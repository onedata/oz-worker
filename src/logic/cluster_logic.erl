...
create_oneprovider_cluster(CreatorUserId, ProviderId) ->
    ...
    gui_static:link_gui(?OP_WORKER, ClusterId, ?EMPTY_GUI_HASH),
    gui_static:link_gui(?OP_PANEL, ClusterId, ?EMPTY_GUI_HASH),
...
delete_oneprovider_cluster(ProviderId) ->
    ...
    gui_static:unlink_gui(?OP_WORKER, ClusterId),
    gui_static:unlink_gui(?OP_PANEL, ClusterId),
