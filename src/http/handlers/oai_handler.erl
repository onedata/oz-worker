...
x() ->
    XML1 = {xmlElement, undefined, [], [],
    {xmlNamespace, [], []},
    [], undefined, [],
    [{xmlElement, 'edm:ProvidedCHO', 'edm:ProvidedCHO',
        {"edm", "ProvidedCHO"},
        {xmlNamespace, [],
        ...
        [{'rdf:RDF', 1}],
        1,
        [{xmlAttribute, 'rdf:about', [],
            {"rdf", "about"},
            [],
            [{'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
            1, [], <<"doi:10.5072/Ezv2GbQ">>, false}],
        [{xmlElement, 'dc:title', 'dc:title',
            {"dc", "title"},
            {xmlNamespace, [],
                [{"dc", 'http://purl.org/dc/elements/1.1/'},
                    {"dcterms", 'http://purl.org/dc/terms/'},
            ...
            [{xmlAttribute, 'xml:lang', [],
                {"xml", "lang"},
                [],
                [{'dc:title', 1}, {'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
                1, [], "en", false}],
            [{xmlText,
                [{'dc:title', 1}, {'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
                1, [], "Metadata Example Record Tier A", text}],
            "en", "/root/bin/node", undeclared},
            {xmlElement, 'dc:type', 'dc:type',
                {"dc", "type"},
                {xmlNamespace, [],
                    [{"dc", 'http://purl.org/dc/elements/1.1/'},
                        {"dcterms", 'http://purl.org/dc/terms/'},
                ...
                2, [],
                [{xmlText,
                    [{'dc:type', 2}, {'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
                    1, [], "book", text}],
                [], "/root/bin/node", undeclared},
            {xmlElement, 'dc:language', 'dc:language',
                {"dc", "language"},
                {xmlNamespace, [],
                    [{"dc", 'http://purl.org/dc/elements/1.1/'},
                        {"dcterms", 'http://purl.org/dc/terms/'},
            ...
            {xmlElement, 'edm:type', 'edm:type',
                ...
                4, [],
                [{xmlText,
                    [{'edm:type', 4}, {'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
                    1, [], "TEXT", text}],
                [], "/root/bin/node", undeclared},
            {xmlElement, 'dcterms:isPartOf', 'dcterms:isPartOf',
                {"dcterms", "isPartOf"},
                {xmlNamespace, [],
                    [{"dc", 'http://purl.org/dc/elements/1.1/'},
                        {"dcterms", 'http://purl.org/dc/terms/'},
                ...
                [{xmlText,
                    [{'dcterms:isPartOf', 5},
                        {'edm:ProvidedCHO', 1},
                        {'rdf:RDF', 1}],
                    1, [], "Europeana Foundation Example Records", text}],
                [], "/root/bin/node", undeclared},
            {xmlElement, 'dc:identifier', 'dc:identifier',
                {"dc", "identifier"},
                {xmlNamespace, [],
                    [{"dc", 'http://purl.org/dc/elements/1.1/'},
                        {"dcterms", 'http://purl.org/dc/terms/'},
                ...
                [{'edm:ProvidedCHO', 1}, {'rdf:RDF', 1}],
                6, [],
                [{xmlText, [], undefined, [], <<"doi:10.5072/Ezv2GbQ">>,
                    text}],
                [], "/root/bin/node", undeclared}],
        [], "/root/bin/node", undeclared},
        {xmlElement, 'ore:Aggregation', 'ore:Aggregation',
            {"ore", "Aggregation"},
            {xmlNamespace, [],
                [{"dc", 'http://purl.org/dc/elements/1.1/'},
                    {"dcterms", 'http://purl.org/dc/terms/'},
            ...
            [{xmlAttribute, 'rdf:about', [],
                {"rdf", "about"},
                [],
                [{'ore:Aggregation', 2}, {'rdf:RDF', 1}],
                1, [], <<"doi:10.5072/Ezv2GbQ_AGG">>, false}],
            [{xmlElement, 'edm:aggregatedCHO', 'edm:aggregatedCHO',
                {"edm", "aggregatedCHO"},
                {xmlNamespace, [],
                    [{"dc", 'http://purl.org/dc/elements/1.1/'},
                        {"dcterms", 'http://purl.org/dc/terms/'},
                ...
                [{'ore:Aggregation', 2}, {'rdf:RDF', 1}],
                1,
                [{xmlAttribute, 'rdf:resource', [], [], [], [], undefined, [],
                    <<"doi:10.5072/Ezv2GbQ">>, undefined}],
                [], [], "/root/bin/node", undeclared},
                {xmlElement, 'edm:dataProvider', 'edm:dataProvider',
                    {"edm", "dataProvider"},
                    {xmlNamespace, [],
                        [{"dc", 'http://purl.org/dc/elements/1.1/'},
                            {"dcterms", 'http://purl.org/dc/terms/'},
                    ...
                    [{xmlText,
                        [{'edm:dataProvider', 2},
                            {'ore:Aggregation', 2},
                            {'rdf:RDF', 1}],
                        1, [], "Europeana Foundation", text}],
                    [], "/root/bin/node", undeclared},
                {xmlElement, 'edm:isShownBy', 'edm:isShownBy',
                    {"edm", "isShownBy"},
                    {xmlNamespace, [],
                        [{"dc", 'http://purl.org/dc/elements/1.1/'},
                            {"dcterms", 'http://purl.org/dc/terms/'},
                    ...
                    [{xmlAttribute, 'rdf:resource', [],
                        ...
                        [{'edm:isShownBy', 3},
                            ...
                            {'rdf:RDF', 1}],
                        1, [],
                        "http://media.culturegrid.org.uk/mediaLibrary/Partage/LoveArtNouveau/Glasgow/DSCF4092.JPG",
                        false}],
                    [], [], "/root/bin/node", undeclared},
                {xmlElement, 'edm:provider', 'edm:provider',
                    {"edm", "provider"},
                    {xmlNamespace, [],
                        [{"dc", 'http://purl.org/dc/elements/1.1/'},
                            {"dcterms", 'http://purl.org/dc/terms/'},
                    ...
                    [{xmlText,
                        ...
                        1, [], "Europeana Foundation", text}],
                    [], "/root/bin/node", undeclared},
                {xmlElement, 'edm:rights', 'edm:rights',
                    {"edm", "rights"},
                    {xmlNamespace, [],
                        [{"dc", 'http://purl.org/dc/elements/1.1/'},
                            {"dcterms", 'http://purl.org/dc/terms/'},
