...
%%% when /saml/consume page is visited. It is used to verify the data
%%% returned by SAML auth providers and log the user in.
%%% @end
%%%-------------------------------------------------------------------
-module(saml_consume_backend).
-author("Lukasz Opiola").
...
page_init() ->
    RedirectURL = case auth_utils:validate_saml_login() of
        {redirect, URL} ->
