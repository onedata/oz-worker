...
PRIMARY_IMAGE='docker.onedata.org/onezone-gui:VFS-4765-fixes-in-groups-hierarchy-view'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/onezone-gui:VFS-4765-fixes-in-groups-hierarchy-view'
