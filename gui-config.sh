...
PRIMARY_IMAGE='docker.onedata.org/onezone-gui:VFS-4540-reimplement-group-related-functionalities'
# Image which will be used if primary image is not resolved.
SECONDARY_IMAGE='onedata/onezone-gui:VFS-4540-reimplement-group-related-functionalities'
